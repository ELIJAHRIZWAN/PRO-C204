...
def askPlayerName():
    ...
    canvas1.create_text(screen_width/4.5,screen_height/8, text = "Enter Name", font=("Chalboard SE",60), fill="black")
    ...
    button = Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, command=saveName, height=2, bd="#80deea", bg=3)
